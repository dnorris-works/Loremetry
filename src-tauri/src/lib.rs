...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            model_recommend::recommend_report_models,
            model_recommend::get_effective_models,
            model_recommend::set_report_model_override,
            model_recommend::clear_report_model_override,
            model_recommend::list_report_model_overrides,
